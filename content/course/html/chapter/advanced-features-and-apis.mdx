...
- WebSockets API: [https://developer.mozilla.org/en-US/docs/Web/API/WebSocket](https://developer.mozilla.org/en-US/docs/Web/API/WebSocket)
- WebGL API: [invalid URL removed]
- History API: [https://developer.mozilla.org/en-US/docs/Web/API/History](https://developer.mozilla.org/en-US/docs/Web/API/History)
- Fetch API: [https://developer.mozilla.org/en-US/docs/Web/API/Fetch](https://developer.mozilla.org/en-US/docs/Web/API/Fetch)
- WebAssembly: [invalid URL removed]
- WebXR: [invalid URL removed]
- Progressive Web Apps: [invalid URL removed]
